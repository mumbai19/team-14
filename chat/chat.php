...
<body>
	...
	<div id="wrapper">
		<center><h1>Welcome <?php session_start(); echo $_SESSION['username']; ?></h1><br>
		...
		$query = $db->prepare("SELECT * FROM signupdata where firstname <> '$current'");
		$run = $query->execute();
		...
		foreach( $rs as $user )
		{
			...
			echo "<div class='user'>".$user->firstname."</div><br>";
